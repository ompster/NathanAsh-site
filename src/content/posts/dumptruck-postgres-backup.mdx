---
title: "DumpTruck — A PostgreSQL Backup Tool"
...
**GUI** for the team — a portable Windows `.exe` that doesn't need Python installed:
...
<div style={{maxWidth: '620px', margin: '1rem auto'}}>
  ![DumpTruck GUI](../assets/dumptruck-gui.png)
</div>
