...
description: "An open-source collection of PowerShell helper functions for Datto RMM — covering UDF writing, structured logging, exit codes, run-as-user execution, and per-user registry modification."
...
1. **Copy what you need** — grab individual functions and paste them into your component
2. **Use the full toolkit** — paste `DattoRMM-Toolkit.ps1` at the top of your component
